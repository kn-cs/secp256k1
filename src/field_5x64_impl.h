...
/*    fprintf(stderr, "Normalize input: %llx%016llx%016llx%016llx%016llx\n", (unsigned long long)t4, (unsigned long long)t3, (unsigned long long)t2, (unsigned long long)t1, (unsigned long long)t0);*/
    mul2(c0,c1,t4,0x1000003D1ULL);
    t4 = 0;
    add2(c0,c1,t0);
    t0 = c0;
    add4(t1,t2,t3,t4,c1);
/*    fprintf(stderr, "Normalize step1: %llx%016llx%016llx%016llx%016llx\n", (unsigned long long)t4, (unsigned long long)t3, (unsigned long long)t2, (unsigned long long)t1, (unsigned long long)t0);*/
    VERIFY_CHECK(t4 == 0 || t4 == 1);

    c0 = (-(t4 | (((~(t1 & t2 & t3)) == 0) & (t0 >= 0xFFFFFFFEFFFFFC2F)))) & 0x1000003D1ULL;
    add4o(t0,t1,t2,t3,c0);
    t4 = 0;
/*    fprintf(stderr, "Normalize step2: %llx%016llx%016llx%016llx%016llx\n", (unsigned long long)t4, (unsigned long long)t3, (unsigned long long)t2, (unsigned long long)t1, (unsigned long long)t0);*/
